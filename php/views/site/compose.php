...
<body style="background-image:url('img/background10.png')">
	...
	<div class="row">
			...
			<div class="row" style="margin-right: 30px;">
				<div class="col-lg-10">
					<h5 style="padding-top: 5px;padding-left: 10px">Title</h5>
				</div>
				<div class="col-lg-1">
					<img id="mic-title" class="tiny-btn" src="img/mic.png" style="float:right;margin-top: 10px" onclick="MicClicked('text-title')">
				</div>
				<div class="col-lg-1">
					<img id="correct-title" class="tiny-btn" src="img/correct.png" style="margin-top: 10px"  onclick="CorrectClicked('text-title')" >
				</div>
			</div>
			<style> input[type="text"] { width: 873px;} </style>
			<input id="text-title" type="text" cols="100" placeholder="Enter your text here" style="width:823px;border-radius: 8px;box-shadow: 4px 7px 8px rgba(0, 0, 0, 0.1);background-color:#e8f8f5; color:#414746;padding-left: 10px">

			<div class="row"  style="margin-right: 30px;">
                                <div class="col-lg-10">
					<h5 style="padding-top: 5px;padding-left: 10px">Introduction</h5>
				</div>
				<div class="col-lg-1">
                                        <img id="mic-intro" class="tiny-btn" src="img/mic.png" style="float:right; margin-top: 10px" onclick="MicClicked('text-intro')">
                                </div>
                                <div class="col-lg-1">
                                        <img id="correct-intro" class="tiny-btn" src="img/correct.png" style="margin-top: 10px" onclick="CorrectClicked('text-intro')">
                                </div>
			</div>
			<textarea id="text-intro" rows="10" cols="100" placeholder="Enter your text here..." style="border-radius: 8px; box-shadow: 4px 7px 8px rgba(0, 0, 0, 0.1);background-color:#e8f8f5;color:#414746;padding-left:10px"></textarea>

			<div class="row"  style="margin-right: 30px;">
                                <div class="col-lg-10">
					<h5 style="padding-top: 5px;padding-left: 10px">Body</h5>
				</div>
				<div class="col-lg-1">
                                        <img id="mic-body" class="tiny-btn" src="img/mic.png" style="float:right; margin-top: 10px" onclick="MicClicked('text-body')">
                                </div>
                                <div class="col-lg-1">
                                        <img id="correct-body" class="tiny-btn" src="img/correct.png" style="margin-top: 10px" onclick="CorrectClicked('text-body')">
                                </div>
			</div>
			<textarea id="text-body" rows="10" cols="100" placeholder="Enter your text here..." style="border-radius: 8px; box-shadow: 4px 7px 8px rgba(0, 0, 0, 0.1);background-color:#e8f8f5;color:#414746;padding-left:10px"></textarea>

			<div class="row"  style="margin-right: 30px;">
                                <div class="col-lg-10">
					<h5 style="padding-top: 5px;padding-left: 10px">Conclusion</h5>
				</div>
				<div class="col-lg-1">
                                        <img id="mic-conclusion" class="tiny-btn" src="img/mic.png" style="float:right; margin-top: 10px" onclick="MicClicked('text-conclusion')">
                                </div>
                                <div class="col-lg-1">
                                        <img id="correct-conclusion" class="tiny-btn" src="img/correct.png" style="margin-top: 10px" onclick="CorrectClicked('text-conclusion')">
                                </div>
			</div>
			<textarea id="text-conclusion" rows="10" cols="100" placeholder="Enter your text here..." style="border-radius: 8px;box-shadow: 4px 7px 8px rgba(0, 0, 0, 0.1);background-color:#e8f8f5;color:#414746;padding-left:10px"></textarea>
            </div>
		...
		<div class="row">
			...
			<textarea id="text-score" rows="8" cols="100" placeholder="Your detailed scores will be here." style="border-radius: 16px;height:190px;padding-top: 5px;box-shadow: 4px 7px 8px rgba(0, 0, 0, 0.1); background-color: #ebf5fb;color:#4bad40"></textarea>
		</div>

		<!-- ###### Begin conversation display area.  ######### -->
		<div class="row">
                	<h5 style="padding-top: 10px;">Conversation</h5>
			<div class="container" id="chatContainer", style="height:450px; border:1px solid #ccc;border-radius: 16px;overflow-y: auto;box-shadow: 4px 7px 8px rgba(0, 0, 0, 0.1);background-color: #ebf5fb; color:#626567">
			</div>
		</div>
		<!-- ##### End conversation display area #### -->

		<div class="row">
			<h10 style="padding-top: 10px;">Ask Question:</h10>
			<textarea id="text-msg" rows="2" cols="100" placeholder="Enter your question here..." style="color: grey;border-radius: 8px;box-shadow: 4px 7px 8px rgba(0, 0, 0, 0.1);background-color:#edf3f2; color:#414746""></textarea>
			
		</div>
		<div class="row">
			<div class="col-lg-7" ></div>
			<div class="col-lg-1", mb-3, style="position: relative;">
				<img id="mic-msg" class="tiny-btn" src="img/mic.png" style="position: absolute; bottom: 0; left: 0px" onclick="MicClicked('text-msg')">
			</div>
    ...
    <!-- Pop-up Window -->
    <div class="popup" id="popup" style="width:550px;height:350px;text-align:center; border-radius: 16px;box-shadow: 4px 7px 8px rgba(0, 0, 0, 0.1)">
	    ...
	    <img id="start-btn" src="img/mic.png" style="margin:20px; width:70px">
  ...
  <script>
    ...
    async function CorrectClicked(text_area) {
       ...
       let result = await callAIAgent(encodeURIComponent(message));
	...
	const displayDiv = document.createElement('div');
        ...
        displayDiv.innerHTML = '&#x1F449 ' + content; 
	//console.log(content)
